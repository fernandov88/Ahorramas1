...
public class AdaptadorProducto
        extends RecyclerView.Adapter<AdaptadorProducto.AdaptadorViewHolder> {
    ...
    public AdaptadorProducto(List<Item> listaItem, Context context) {
    ...
    public void consumirServicio(){
        ...
        /*ServcioTaskProducto servcioTask = new ServcioTaskProducto(context,"https://apex.oracle.com/pls/apex/pruebas123/api/CABECERA",getuCorrreo(),fecha,tvDescripcion.getText().toString());
        servcioTask.execute();*/
    }
}
