...
public class ServcioTask extends AsyncTask<Void, Void, String> {
    ...
    public ServcioTask(Context httpContext, String linkRequestApi, String pCorreo, String pFecha, String pNombreLista) {
    ...
    protected String doInBackground(Void... params){
        ...
        try {
            ...
            parametrosPost.put("CORREO",""+pCorreo);
    ...
    protected void onPostExecute(String s){
        ...
        resultadoApi = s;
        Toast.makeText(httpContext,"Lista creada: "+resultadoApi,Toast.LENGTH_LONG).show();
    }
